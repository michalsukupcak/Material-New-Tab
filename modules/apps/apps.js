(function (document) {
     ...
     * @returns {number}
     */
    var compareApps =  function (leftApp, rightApp) {
     ...
     * MODULE: Apps
     *
     * @type {{compareApps: Function, loadApps: Function}}
     */
    var module_apps = {

        /**
         * Loads and filters apps from Chrome extensions, then inserts them into HTML code.
         */
        loadApps: function () {
     ...
     * Start apps module.
     */
    module_apps.loadApps();

    /**
     * Click event listener for open all apps button.
     */
